"""
--------------------------------------------------
--- THIS MODULE IS USING WORD2VEC AND WORD NET ---
--------------------------------------------------
"""
import pandas as pd
...
class SearchEngine:
    ...
    def search(self, query):
        ...
        extended_query = word_net.get_all_synonyms_for_a_sentence(query)
        return searcher.search(extended_query)
